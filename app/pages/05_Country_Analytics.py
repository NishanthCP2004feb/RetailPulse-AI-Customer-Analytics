...
with kpi1: kpi_card("Countries", format_number(total_countries), "🌍")
with kpi2: kpi_card("Total Revenue", format_compact_currency(total_revenue), "💰")
with kpi3: kpi_card("Total Orders", format_number(total_orders), "📦")
with kpi4: kpi_card("Customers", format_number(total_customers), "👥")
with kpi5: kpi_card("Avg Rev/Country", format_compact_currency(average_country_revenue), "🧮")
with kpi6: kpi_card("Top Country", top_country, "🏆")
